...
conda install -y -n ${env_name} -c conda-forge scikit-learn lightning jupyter umap-learn matplotlib seaborn pandas rdkit tqdm optuna graphviz torchinfo tabulate
